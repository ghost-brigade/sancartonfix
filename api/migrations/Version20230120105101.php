 ...
 */
final class Version20230120105101 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE housing (id UUID NOT NULL, owner_id UUID NOT NULL, category_id UUID NOT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, latitude NUMERIC(10, 8) DEFAULT NULL, longitude NUMERIC(11, 8) DEFAULT NULL, price NUMERIC(10, 2) NOT NULL, active BOOLEAN NOT NULL, slug VARCHAR(128) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE password_forgot_token (id UUID NOT NULL, account_id UUID NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE renting (id UUID NOT NULL, client_id UUID NOT NULL, housing_id UUID NOT NULL, date_start DATE NOT NULL, date_end DATE NOT NULL, status BOOLEAN DEFAULT NULL, price DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id))');
